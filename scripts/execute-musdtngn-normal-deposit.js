...
async function main() {
    ...
    console.log("=== Executing Normal mUSDTNGN Deposit with Mock Oracle Provider ===\n");
    ...
    let depositKey;
    try {
        depositKey = fs.readFileSync("latest-musdtngn-normal-deposit-key.txt", "utf8").trim();
        console.log("Deposit Key:", depositKey);
    } catch (e) {
        console.log("❌ Could not read deposit key");
        console.log("  Please run: npx hardhat run scripts/create-musdtngn-normal-deposit.js --network arbitrumSepolia");
        return;
    }
    ...
    // Build oracle params with provider for three tokens
    ...
    console.log("  Deposit: 100,000 mUSD + 150,000,000 mNGN = $200,000 USD total");
