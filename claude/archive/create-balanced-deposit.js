...
async function main() {
    ...
    console.log("=== Creating Balanced Deposit (50/50 Split) ===\n");
    ...
    if (vaultBalance.lt(ethers.utils.parseUnits("100", 6))) {
        console.log("  ⚠️  DepositVault needs at least 100 USDT");
    ...
    try {
        ...
        console.log("   - Both tokens set to USDT (single-token market)");
