...
async function main() {
    ...
    console.log("=== Closing COP Position ===\n");
    ...
    const orderParams = {
        ...
        numbers: {
            ...
            triggerPrice: 0,
            acceptablePrice: ethers.utils.parseUnits("3000", 12), // Min acceptable price for closing long (3000 COP per USDT)
    ...
    try {
        ...
        if (orderKey) {
            ...
            // Save to file
            const fs = require("fs");
            fs.writeFileSync("latest-close-order-key-cop.txt", orderKey);
            console.log("📝 Saved order key to: latest-close-order-key-cop.txt");
        }
