...
async function main() {
    ...
    console.log("=== Closing TSLA Position ===\n");
    ...
    const orderParams = {
        ...
        numbers: {
            ...
            triggerPrice: 0,
            acceptablePrice: ethers.utils.parseUnits("300", 12), // Min acceptable price for closing long ($300 per TSLA)
    ...
    try {
        ...
        if (orderKey) {
            ...
            // Save to file
            const fs = require("fs");
            fs.writeFileSync("latest-close-order-key-tsla.txt", orderKey);
            console.log("📝 Saved order key to: latest-close-order-key-tsla.txt");
        }
