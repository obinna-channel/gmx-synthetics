...
async function main() {
    ...
    console.log("=== Closing PKR SHORT Position ===\n");
    ...
    const orderParams = {
        ...
        numbers: {
            ...
            triggerPrice: 0,
            acceptablePrice: ethers.utils.parseUnits("400", 12), // Max acceptable price for closing short (400 PKR per USDT)
    ...
    try {
        ...
        if (orderKey) {
            ...
            // Save to file
            const fs = require("fs");
            fs.writeFileSync("latest-close-order-key-pkr-short.txt", orderKey);
            console.log("📝 Saved order key to: latest-close-order-key-pkr-short.txt");
        }
