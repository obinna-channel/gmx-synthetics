...
async function main() {
    ...
    console.log("=== Creating Test Order for TSLA/USD Market ===\n");
    ...
    // Order parameters - Long position on TSLA
    ...
    console.log("  Type: Market Increase (Long TSLA)");
    ...
    // 3. Create market increase order (Long TSLA)
    const orderParams = {
        addresses: {
        ...
        numbers: {
            ...
            acceptablePrice: ethers.utils.parseUnits("1000", 12), // $1000 max acceptable price for TSLA (30 - 18 decimals)
        ...
        isLong: true, // Long TSLA position
    ...
    try {
        ...
        if (orderKey) {
            ...
            // Save to file
            const fs = require("fs");
            fs.writeFileSync("latest-order-key-tsla.txt", orderKey);
            console.log("📝 Saved order key to: latest-order-key-tsla.txt");
        }
