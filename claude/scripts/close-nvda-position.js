...
async function main() {
    ...
    console.log("=== Closing NVDA Position ===\n");
    ...
    const orderParams = {
        ...
        numbers: {
            ...
            triggerPrice: 0,
            acceptablePrice: ethers.utils.parseUnits("100", 12), // Min acceptable price for closing long ($100 per NVDA)
    ...
    try {
        ...
        if (orderKey) {
            ...
            // Save to file
            const fs = require("fs");
            fs.writeFileSync("latest-close-order-key-nvda.txt", orderKey);
            console.log("📝 Saved order key to: latest-close-order-key-nvda.txt");
        }
