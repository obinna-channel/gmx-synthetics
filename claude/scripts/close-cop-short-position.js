...
async function main() {
    ...
    console.log("=== Closing COP SHORT Position ===\n");
    ...
    const orderParams = {
        ...
        numbers: {
            ...
            triggerPrice: 0,
            acceptablePrice: ethers.utils.parseUnits("5000", 12), // Max acceptable price for closing short (5000 COP per USDT)
    ...
    try {
        ...
        if (orderKey) {
            ...
            // Save to file
            const fs = require("fs");
            fs.writeFileSync("latest-close-order-key-cop-short.txt", orderKey);
            console.log("📝 Saved order key to: latest-close-order-key-cop-short.txt");
        }
